...
{ 
    ...
    //  public          bool AllowRecursion     { get; set; }
        ...
        bool IUpdateable.Update() => Reconcile();
    
        #endregion
    }
    
    
    public abstract class ResultBase : CausalFactor, IResult, IDependency, IInfluenceable, IUpdateable
    {
        #region Constants
