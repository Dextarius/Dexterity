...
{
    public abstract class DirectListResult<T> : DirectCollectionResult<List<T>, T>, IListResult<T>
    {
        ...
        //^ We may want to pause the Observer if it seems users will call this inside a reaction and
        //  expect that it will make the new collection without creating any dependencies.
