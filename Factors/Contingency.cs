...
// namespace Factors
// {
//     //- Consider if we want to make this class contain a Reactive, as opposed to inheriting one.
//     //  Think if there are any members which might lead people to make mistakes (such as someone
//     //  setting IsImpulsive to true and then IsReflexive to false, and then wondering why the
