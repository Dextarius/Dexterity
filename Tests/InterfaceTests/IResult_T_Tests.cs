...
namespace Tests.InterfaceTests
{
    ...
    [TestFixture(typeof(Result<int>  ), typeof(Reactor_Int_Factory  ), typeof(CausalFactor), typeof(CausalFactor_Factory), typeof(int))]
    ...
    public class IResult_T_Tests<TResult, TDependent, TOutcomeFactory, TDependentFactory, TValue>  
        ...
        where TOutcomeFactory   : IReactorFactory<TResult, TValue>, new()
