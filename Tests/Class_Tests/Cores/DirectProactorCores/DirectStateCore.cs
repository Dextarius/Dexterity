...
{
    public class DirectStateCores : 
        ITestableConstructor_Name<DirectStateCore<int>>,
        ITestableConstructor_Value<DirectStateCore<int>,  int> 
    {
        ...
        public DirectStateCore<int>[] CallAllConstructors_AndPassValue(int valueToUse)
        {
            return new[]
            {
                new DirectStateCore<int>(0),
                new DirectStateCore<int>(0, "Name")
            };
        }
        
        public int CreateRandomValue() => GenerateRandomInt();

        public int CreateRandomValueNotEqualTo(int valueToAvoid) => 
