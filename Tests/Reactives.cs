    ...
    public class Reactives
    {
        ...
        public void AfterConstruction_IsNotReflexive()
        {
            ...
            Assert.That(reactiveToTest.IsReflexive, Is.False, 
                $"The property {nameof(reactiveToTest.IsReflexive)} was marked as true during construction.");
        }

        [Test]
        public void AfterConstruction_HasDependentsIsFalse()
        {
            Reactive<int> reactiveToTest = new Reactive<int>(Return42);
        ...
        // [Test]
        // public void WhenUpdatingAfterParentStateChanges_DependentReactivesUpdateAccordingToDependenceHierarchy()
        // {
        //     Reactive<int> reactive1 = new Reactive<int>(ReturnTheNumber42);
        //     Reactive<int> reactive2 = CreateReactiveThatGetsValueOf(reactive1);
        //     Reactive<int> reactive3 = CreateReactiveThatGetsValueOf(reactive2);
        //     Reactive<int> reactive4 = CreateReactiveThatGetsValueOf(reactive3);
        //     Reactive<int> reactive5 = CreateReactiveThatGetsValueOf(reactive4);
        //
        //
        //
        //     int CreateReactiveThatReturns(int number, Reactive<in>)
        //     {
